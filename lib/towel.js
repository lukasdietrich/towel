...
Towel.prototype.registerCollection = function (name, structure, significantKey) {
    ...
    if (name.indexOf("towel_") !== 0) {
        ...
        if (_.isUndefined(this._collections[name])) {
            ...
            this._collections[name] = new Collection(this.db.collection(name), structure, significantKey);
